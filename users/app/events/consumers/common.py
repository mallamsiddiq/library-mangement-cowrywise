...
def start_event_consumer(exchange, queue_name, callback, max_retries=10, retry_delay=5):
    ...
    while retries < max_retries:
        try:
            ...
            if retries < max_retries:
                ...
                print(f"Max retries reached. Could not establish connection to {AMQP_URL}")
                break
